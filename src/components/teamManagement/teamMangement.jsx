...
import CreateTaskFormForTeam from "../createTaskModal/createTaskWithTeam";
import TeamTaskList from "../card/TeamTaskList";
      ...
      <div className="py-8">
        <div className="px-4 py-4 -mx-4 overflow-x-auto sm:-mx-8 sm:px-8">
          ...
          <div>
            ...
            >
              {teamName ? `Create new task` : `Create new task board`}
            </button>
          </div>
                    ...
                    >
                      <div className="flex items-center justify-between">
                        ...
                        {tasks.filter((task) => task.label === label).length >
                          0 && (
                          <SelectSortField listname={label} isTeam={true} />
                        )}
                      </div>
                    </th>
                  ))}
      ...
      </div>
      {
        ...
        isOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center">
            ...
            ></div>
            <CreateTaskFormForTeam updateModal={updateModal} />
          </div>
        )
      }

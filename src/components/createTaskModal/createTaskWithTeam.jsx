...
const CreateTaskFormForTeam = ({ updateModal }) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (validateForm()) {
      ...
      const existingTasks = JSON.parse(localStorage.getItem("taskTeams")) || [];
      existingTasks.push(newTask);
      localStorage.setItem("taskTeams", JSON.stringify(existingTasks));
      if (!teamName) {
...
export default CreateTaskFormForTeam;
